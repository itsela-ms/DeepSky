...
contextBridge.exposeInMainWorld('api', {
  ...
  getSessionNotes: (sessionId) => ipcRenderer.invoke('session:getNotes', sessionId),
  addSessionNote: (sessionId, text) => ipcRenderer.invoke('session:addNote', sessionId, text),
  updateSessionNote: (sessionId, noteId, text) => ipcRenderer.invoke('session:updateNote', sessionId, noteId, text),
  deleteSessionNote: (sessionId, noteId) => ipcRenderer.invoke('session:deleteNote', sessionId, noteId),
  ...
  getFileDiff: (filePath) => ipcRenderer.invoke('file:getDiff', filePath),
